...
export async function GET(req: NextRequest) {
  try {
    ...
    const staff = await prisma.staff.findMany({ where: { status: 'Active' }, select: { id: true, fullName: true, employeeCode: true, designation: true, joiningDate: true, basicSalary: true }, orderBy: { fullName: 'asc' } });
