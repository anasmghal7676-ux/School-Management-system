...
import { IconRefresh, IconAlertCircle, IconMapPin } from '@tabler/icons-react';
...
export default function Page() {
  ...
  async function load() {
    setLoading(true);
    try {
      const r = await fetch('/api/asset-tracking').then(r => r.json());
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Asset Tracking</Text>
          <Text size="sm" c="dimmed">Asset location & maintenance</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="teal" radius="md" style={{ maxWidth: 400 }}>
              No asset tracking records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
