...
import { IconRefresh, IconAlertCircle, IconFlask } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Lab Management</Text>
          <Text size="sm" c="dimmed">Computer & science labs</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="teal" radius="md" style={{ maxWidth: 400 }}>
              No lab management records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
