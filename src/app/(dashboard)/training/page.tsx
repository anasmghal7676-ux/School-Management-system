...
export default function TrainingPage() {
  ...
  const cols  = ['Staff', 'Program', 'Duration', 'Provider', 'Status'];

  return (
    <Container size="xl" py="md">
      <Group justify="space-between" mb="lg">
        <Title order={2}>Training Records</Title>
        <Group gap="sm">
              ...
              {records.length === 0 ? (
                <Table.Tr>
                  <Table.Td colSpan={cols.length + 1}>
                    <Center py="xl"><Text c="dimmed">No training records records found</Text></Center>
                  </Table.Td>
                </Table.Tr>
