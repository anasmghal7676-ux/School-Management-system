...
export default function Page() {
  ...
  async function load() {
    setLoading(true);
    try {
      const r = await fetch('/api/fee-fines').then(r => r.json());
    ...
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          ...
          <Text size="sm" c="dimmed">Late payment fines & penalties</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="red" radius="md" style={{ maxWidth: 400 }}>
              No fee fines records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
