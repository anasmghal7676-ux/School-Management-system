...
import { IconRefresh, IconAlertCircle, IconMessage } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">SMS Gateway</Text>
          <Text size="sm" c="dimmed">SMS configuration & logs</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="teal" radius="md" style={{ maxWidth: 400 }}>
              No sms gateway records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
