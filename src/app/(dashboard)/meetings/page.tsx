  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Meetings</Text>
          <Text size="sm" c="dimmed">Staff & admin meetings</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="indigo" radius="md" style={{ maxWidth: 400 }}>
              No meetings records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
