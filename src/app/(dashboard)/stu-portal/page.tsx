  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Student Portal</Text>
          <Text size="sm" c="dimmed">Student self-service portal</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="blue" radius="md" style={{ maxWidth: 400 }}>
              No student portal records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
