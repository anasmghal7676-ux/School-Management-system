  ...
  return (
    <Box p="xl">
      <Box mb="xl">
        ...
        <Text size="sm" c="dimmed">Classroom resources and assignment</Text>
      </Box>
      ...
      <Card shadow="xs" radius="md" p="xl" style={{ border: '1px solid #f1f5f9', background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', textAlign: 'center' }}>
        <Stack align="center" gap="md" py="xl">
          ...
          <Text size="lg" fw={600}>Classrooms</Text>
          <Text size="sm" c="dimmed" style={{ maxWidth: 400 }}>Classroom resources and assignment. Data will populate as you use the system.</Text>
