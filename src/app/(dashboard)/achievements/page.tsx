  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Achievements</Text>
          <Text size="sm" c="dimmed">Student & staff achievements</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="yellow" radius="md" style={{ maxWidth: 400 }}>
              No achievements records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
