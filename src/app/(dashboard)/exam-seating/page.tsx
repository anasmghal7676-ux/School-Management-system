  ...
  return (
    <Box p="xl">
      <Box mb="xl">
        ...
        <Text size="sm" c="dimmed">Seating arrangement for exams</Text>
      </Box>
      ...
      <Card shadow="xs" radius="md" p="xl" style={{ border: '1px solid #f1f5f9', background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', textAlign: 'center' }}>
        <Stack align="center" gap="md" py="xl">
          ...
          <Text size="lg" fw={600}>Exam Seating</Text>
          <Text size="sm" c="dimmed" style={{ maxWidth: 400 }}>Seating arrangement for exams. Data will populate as you use the system.</Text>
