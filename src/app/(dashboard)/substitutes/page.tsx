...
import { IconRefresh, IconAlertCircle, IconUserCheck } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Substitutes</Text>
          <Text size="sm" c="dimmed">Substitute teacher management</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="yellow" radius="md" style={{ maxWidth: 400 }}>
              No substitutes records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
