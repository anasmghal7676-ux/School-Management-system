...
export default function SubstitutesPage() {
  ...
  const cols  = ['Absent Teacher', 'Subject', 'Substitute', 'Date', 'Period'];

  return (
    <Container size="xl" py="md">
      <Group justify="space-between" mb="lg">
        <Title order={2}>Substitutes</Title>
        <Group gap="sm">
              ...
              {records.length === 0 ? (
                <Table.Tr>
                  <Table.Td colSpan={cols.length + 1}>
                    <Center py="xl"><Text c="dimmed">No substitutes records found</Text></Center>
                  </Table.Td>
                </Table.Tr>
