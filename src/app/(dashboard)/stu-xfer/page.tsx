...
import { IconRefresh, IconAlertCircle, IconArrowRight } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Student Transfer</Text>
          <Text size="sm" c="dimmed">Student transfer management</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="orange" radius="md" style={{ maxWidth: 400 }}>
              No student transfer records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
