...
import { IconRefresh, IconAlertCircle, IconActivity } from '@tabler/icons-react';
    ...
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          ...
          <Text size="sm" c="dimmed">System status & monitoring</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="green" radius="md" style={{ maxWidth: 400 }}>
              No system health records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
