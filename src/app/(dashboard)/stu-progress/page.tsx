...
import { IconRefresh, IconAlertCircle, IconTrendingUp } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Student Progress</Text>
          <Text size="sm" c="dimmed">Academic progress tracking</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="green" radius="md" style={{ maxWidth: 400 }}>
              No student progress records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
