...
import { IconRefresh, IconAlertCircle, IconStar } from '@tabler/icons-react';
...
export default function Page() {
  ...
  async function load() {
    setLoading(true);
    try {
      const r = await fetch('/api/co-curricular').then(r => r.json());
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Co-Curricular</Text>
          <Text size="sm" c="dimmed">Extracurricular activities</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="yellow" radius="md" style={{ maxWidth: 400 }}>
              No co-curricular records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
