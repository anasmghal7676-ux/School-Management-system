...
import { IconRefresh, IconAlertCircle, IconHistory } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">Communication Log</Text>
          <Text size="sm" c="dimmed">All communication history</Text>
        </Box>
      ...
      <Card shadow="xs" radius="md" p="xl" style={{ border: '1px solid #f1f5f9', textAlign: 'center' }}>
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="gray" radius="md" style={{ maxWidth: 400 }}>
              No communication log records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
          <Stack align="center" gap="sm" py="md">
            <Badge size="xl" variant="light" color="gray">{data.length} records loaded</Badge>
