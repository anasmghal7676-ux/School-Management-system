...
import { IconRefresh, IconAlertCircle, IconVideo } from '@tabler/icons-react';
  ...
  return (
    <Box p="xl">
      <Group justify="space-between" mb="xl">
        <Box>
          <Text size="xl" fw={700} c="#0f172a">CCTV Log</Text>
          <Text size="sm" c="dimmed">Security camera logs</Text>
        </Box>
        ...
        {loading ? (
          ...
          <Stack align="center" gap="md" py="xl">
            <Alert icon={<IconAlertCircle size={16} />} color="gray" radius="md" style={{ maxWidth: 400 }}>
              No cctv log records found. This section will populate as you use the system.
            </Alert>
          </Stack>
        ) : (
